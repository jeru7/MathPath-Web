  ...
  return (
    <>
      <nav className="font-baloo w-full bg-[var(--color-green-primary)] p-5 text-white shadow md:flex md:items-center md:justify-between">
        ...
        <ul className={
          `absolute left-0 w-full bg-[var(--color-green-primary)] py-4 pl-3 md:static md:z-auto md:flex md:w-fit md:items-center md:py-0 md:pl-0 md:opacity-100 ${isOpen ? "opacity-100" : "hidden opacity-0"}`}>
