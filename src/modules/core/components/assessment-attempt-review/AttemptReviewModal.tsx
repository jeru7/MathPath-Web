...
export default function AttemptReviewModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[100dvw] h-[100dvh] max-w-none flex flex-col p-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-y bg-muted flex-shrink-0">
          <Button
            variant="ghost"
