...
export default function AddTeacherModal({
  isOpen,
  onClose,
}: AddTeacherFormProps): ReactElement {
  ...
  return (
    <ModalOverlay isOpen={isOpen} onClose={handleClose}>
      <article className="relative h-[90vh] w-full max-w-[1000px] p-4 shadow-sm md:h-fit md:w-[80vw] md:overflow-x-hidden lg:w-[60vw] overflow-y-auto rounded-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
